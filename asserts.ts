...
import { red, green, white, gray, bold, stripColor } from "https://deno.land/x/std/fmt/colors.ts";
import diff, { DiffType, DiffResult } from 'https://deno.land/x/std/testing/diff.ts'; //"./diff.ts";
